...
--
-- Host: 127.0.0.1
-- Generation Time: 19.11.2025 klo 08:10
...
--
CREATE DATABASE IF NOT EXISTS `weather_app` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `weather_app`;
-- --------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `role` enum('user','admin','deleted') NOT NULL
